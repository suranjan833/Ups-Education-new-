...
class MyAccountView extends GetView<MyAccountController> {
  ...
  Widget build(BuildContext context) {
    var controller =
        Get.put<MyAccountController>(MyAccountController(), permanent: false);
    ...
    return Scaffold(
        ...
        body: RefreshIndicator(
          onRefresh: () {
            controller.isAccountLoading.value == true;
            return controller.myAccountData();
          },
          child: Obx(
